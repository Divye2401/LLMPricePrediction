...
#                       "datasets", "requests", "torch", "peft", "bitsandbytes", 
...
# Create zip file for download (uncomment for Colab)
# import zipfile
# with zipfile.ZipFile("chroma_index.zip", "w") as zipf:
#     for root, dirs, files in os.walk("chroma_train_index"):
#         for file in files:
