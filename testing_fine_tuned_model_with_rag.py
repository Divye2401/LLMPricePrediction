...
This script loads the fine-tuned model and evaluates its performance on test data
...
#                       "datasets", "peft", "requests", "torch", "bitsandbytes", 
#                       "transformers", "trl", "accelerate", "sentencepiece", 
#                       "matplotlib", "langchain-community", "chromadb"])

import os
import re
import math

# from google.colab import userdata  # Uncomment for Colab
...
if not os.path.exists("chroma_train_index"):
    print("ChromaDB not found, creating from training data...")
    ...
    chroma.persist()
    print("ChromaDB created and saved to ./chroma_train_index")
else:
    print("Loading existing ChromaDB from ./chroma_train_index")
    chroma = Chroma(
        persist_directory="chroma_train_index",
